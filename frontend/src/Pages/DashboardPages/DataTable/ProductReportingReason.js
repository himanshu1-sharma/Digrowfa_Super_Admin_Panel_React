...
export default function StickyHeadTable() {
    ...
    const fetchData = () => {
        Axios.get(`${BASEURL}api/report/report-product-reasons`)
            .then(data => {
    ...
    const myFunction = async () => {
        try {
            await Axios.delete(`${BASEURL}api/report/report-product-reasons/${selected}`)
...
function MyVerticallyCenteredModal(props) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            await Axios.post(`${BASEURL}api/report/report-product-reasons`, { category: input })
            props.onHide()
            setInput()
